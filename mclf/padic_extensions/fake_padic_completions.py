...
#                   auxiliary functions
    ...
    def approximate_factorization(self, f, only_ramified_factors=False):
        ...
        # V = vK.mac_lane_approximants(f, require_incomparability=True, assume_squarefree=True, require_maximal_degree=True)
        # the following should be useless because of 'require_maximal_degree':
        ...
        if only_ramified_factors:
            ...
            # we can ignore the factors of degree one
        ...
        for v in V:
            ...
            # this should now be superfluous:
            # e = ZZ(vK(vK.uniformizer())/v(v.uniformizer()))
            e = v._approximation.E()
            print "g = ", g
            print "e = ", e
            # if (not only_ramified_factors) or (e > 1):
            factor_list.append((g, e))
        return factor_list

    def _prefactor(self, f):
        R = f.parent()
